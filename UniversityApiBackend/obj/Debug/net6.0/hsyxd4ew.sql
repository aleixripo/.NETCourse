...
CREATE TABLE [Users] (
    ...
    [UpdatedB] nvarchar(max) NOT NULL,
...
VALUES (N'20221007082327_Create Users Table', N'6.0.9');
GO
...
CREATE TABLE [Courses] (
    ...
    [Requeriments] nvarchar(max) NOT NULL,
    [level] int NOT NULL,
    [CreatedBy] nvarchar(max) NOT NULL,
    [CreatedAt] datetime2 NOT NULL,
    [UpdatedB] nvarchar(max) NOT NULL,
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20221007085012_Create Course Table', N'6.0.9');
GO
...
EXEC sp_rename N'[Users].[UpdatedB]', N'UpdatedBy', N'COLUMN';
GO

EXEC sp_rename N'[Courses].[level]', N'Level', N'COLUMN';
GO

EXEC sp_rename N'[Courses].[UpdatedB]', N'UpdatedBy', N'COLUMN';
GO

EXEC sp_rename N'[Courses].[Description]', N'ShortDescription', N'COLUMN';
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20221011080037_Create Models and Controllers', N'6.0.9');
GO
